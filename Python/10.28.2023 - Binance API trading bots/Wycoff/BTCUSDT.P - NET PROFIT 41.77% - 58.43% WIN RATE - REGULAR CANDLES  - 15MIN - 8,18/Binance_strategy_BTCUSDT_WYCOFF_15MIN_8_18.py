...
import numpy as np
import time
from Binance_setup_WYCOFF_BTCUSDT import BinanceBot
from Binance_config_BTCUSDT_WYCOFF import api_key, api_secret
...
ACCUMULATION_LENGTH = 8

DISTRIBUTION_LENGTH = 18
