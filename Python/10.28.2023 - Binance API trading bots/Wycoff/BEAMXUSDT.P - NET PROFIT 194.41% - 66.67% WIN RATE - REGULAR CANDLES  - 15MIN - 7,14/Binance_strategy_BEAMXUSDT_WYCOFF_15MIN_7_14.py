...
import numpy as np
import time
from Binance_setup_WYCOFF_BEAMXUSDT import BinanceBot
from Binance_config_BEAMXUSDT_WYCOFF import api_key, api_secret
...
ACCUMULATION_LENGTH = 7

DISTRIBUTION_LENGTH = 14
