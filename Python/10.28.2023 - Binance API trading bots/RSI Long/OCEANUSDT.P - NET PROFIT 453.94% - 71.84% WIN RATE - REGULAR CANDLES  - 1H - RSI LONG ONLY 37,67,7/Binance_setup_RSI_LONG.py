...
class BinanceBot:
    def __init__(self, api_key, api_secret):
        ...
        self.pair = 'OCEANUSDT'  # Default trading pair
        self.leverage = 5  # Default leverage level
        self.data = None  # To store fetched data
        self.limit = 300  # Limit for data fetching
        self.interval = '1h'  # Interval for data fetching
...
def main():
    from Binance_config_OCEANUSDT_RSI_LONG import api_key, api_secret
